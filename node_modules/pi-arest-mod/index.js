...
var camera = new RaspiCam({mode: "photo",
  width: 1280,
  height: 720,
  output: "./public/pictures/camera/image.jpg",
  encoding: "jpg",
  timeout: 0,
  n: true
});
...
module.exports = function (app) {
    ...
    // Variables
    app.get('/rest/:variable', function(req, res){
    ...
    // Camera snapshot
    app.get('/rest/camera/snapshot', function(req, res){
    ...
    // Digital write
    app.get('/rest/digital/:pin/:state', function(req, res){
    ...
    // Digital read
    app.get('/rest/digital/:pin', function(req, res){
